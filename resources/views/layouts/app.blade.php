        ...
        <header class=" py-6">
            <div class="container mx-auto flex justify-between items-center px-6">
                <div>
                    ...
                    <a href="/admin/home" class="text-lg font-black bg-gray-300 p-2 rounded uppercase text-gray-800">{{ __('SPOP-LINE') }}</a>
                    @else
                    <a href="/home" class="text-lg font-black bg-gray-300 p-2 rounded uppercase text-gray-800">{{ __('SPOP-LINE') }}</a>
                    @endif
                </div>
