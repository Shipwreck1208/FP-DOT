...
<main class="sm:container sm:mx-auto sm:mt-10">
    <div class="w-full sm:px-6">
        ...
        <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-lg">
            ...
            <a class="bg-gray-300 p-3 text-gray-800 mt-5 rounded font-bold" href="/categories">Categories</a>
            <a class="bg-gray-300 p-3 text-gray-800 mt-5 rounded font-bold" href="/products">Products</a>
            {{-- <a class="bg-gray-300 p-3 text-gray-800 mt-5 rounded font-bold" href="/event">Events</a> --}}
            <a class="bg-gray-300 p-3 text-gray-800 mt-5 rounded font-bold" href="/users">Users</a>

            <div class="bg-gray-300 p-3 text-gray-800 m-6 rounded-2xl font-bold">
