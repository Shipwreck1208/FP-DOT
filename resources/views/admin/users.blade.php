...
<main class="sm:container sm:mx-auto sm:mt-10">
    <div class="w-full sm:px-6">
        ...
        <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-lg">
            ...
            <a class="bg-gray-300 p-3 text-gray-800 m-3 rounded border border-gray-800 hover:bg-gray-800 hover:text-gray-300 float-right font-bold" href="/admin/home">Back</a><br><br>
            <div class="container mx-auto">
                <div class="grid grid-cols-3 gap-5">
                            @foreach ($users as $user)
                            @if($user->is_admin == 0)
                            <div class="bg-gray-300 p-3 text-gray-800 m-3 rounded border border-gray-800 hover:bg-gray-800 hover:text-gray-300 font-bold w-52">
